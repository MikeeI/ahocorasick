...
| [ISSUE-002](issues/ISSUE-002.md) | Search: maximal match still scans the remaining haystack | Submitted | Pull-Request-Implementation | New-pull-request | High | Monitor upstream review | https://github.com/coregx/ahocorasick/pull/10 |
